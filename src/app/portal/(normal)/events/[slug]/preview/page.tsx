...
export default async function EventPreviewPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { data, error } = await supabase
    .from("upcoming_event")
    .select("slug, status, title_ar, title_fr, body_ar, body_fr, event_date, venue_ar, venue_fr, institution_ar, institution_fr, role, role_other_ar, role_other_fr, registration_url")
    .eq("slug", slug)
